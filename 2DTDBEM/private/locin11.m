...
act = (time0 * (log(p0+raiz(p0))/p0 + asin(1/p0))-...
    time1 *(log(p1+raiz(p1))/p1 + asin(1/p1)))/cp+...
    (time0 * (log(s0+raiz(s0))/s0 + asin(1/s0))-...
    time1 *(log(s1+raiz(s1))/s1 + asin(1/s1)))/cs;
bct = (time0*asin(1/p0)-time1*asin(1/p1))/cp-...
    (time0*asin(1/s0)-time1*asin(1/s1))/cs;
if p0>1

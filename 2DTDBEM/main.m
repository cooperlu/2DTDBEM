...
nstep = 150; % Total Time Step

% Geometry
% Original Mesh
x = [0:0.1:1,ones([1,9]),1:-0.1:0,zeros([1,9])];
y = [zeros([1,10]),0:0.1:1,ones([1,9]),1:-0.1:0.1];
n = 40;
nn = 2*n;
...
bck(21:2:39,10:end) = ones(size(bck(21:2:39,10:end))); % HARD CODING!!!!!
kode =  zeros([2*n,nstep]); % type of BC
kode(61:80,:) = ones(size(kode(61:80,:)));% HARD CODING!!!!!
